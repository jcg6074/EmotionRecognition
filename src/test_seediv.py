...
class decoder(nn.Module):
    def __init__(self):
        super().__init__()
        self.msa = MSA(64)
        self.cnnt_layer1 = nn.Conv2d(32,64,kernel_size=(1,1),stride=1,padding=0)
...
class FastSlow(nn.Module):
    ...
    def forward(self, x, p, m):
        ...
        cls_token = cls_token.unsqueeze(dim=-1).repeat(1,1,64,5)
